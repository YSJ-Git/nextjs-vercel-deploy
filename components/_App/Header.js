        ...
        <div className="max-w-[100%] mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              ...
              <a
                href="#"
                className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-cyan-500 hover:bg-cyan-600"
              >
                Sign up
              </a>
            </div>
